...
<body>
    ...
    <div id="content">
        <div class="left">
            <p class="titleContent">Category</p>
            <div class="cateList">
                <ul>
                    <?php
                    $connect = mysqli_connect('localhost', 'root', '', 'bookstore');
                    ...
                    while ($row_product = mysqli_fetch_array($result)) {
                        ...
                        echo "
                    <a href='ProductCate.php?id=$cate_id'><li>$cate_name</li></a>
                ";
                    }
                    ?>
                </ul>
        ...
        <div class="right">
            ...
            $param = $_GET['id'];
            $sql = "SELECT * FROM category WHERE CategoryID = $param";
            //Step 3: Execute query and save result to var $result
            $result = mysqli_query($connect, $sql);
            //display books to screen
            ...
            while ($row_product = mysqli_fetch_array($result)) {
                ...
                $cate_name = $row_product['CategoryName'];
                echo "
                    <p class='titleContent'>$cate_name</p>
                ";
            }
            ?>
            ...
            <div class="listBook">
                ...
                $param = $_GET['id'];
                $sql = "SELECT * FROM book WHERE CategoryID = $param";
                $result = mysqli_query($connect, $sql);
